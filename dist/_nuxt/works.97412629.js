...
Hakatons & party out of office. Free conference that you want.
  ...
  },
  {
    ...
    numberImg: 5,
    descDeal:
      '<p>The company want to refuse from commercial plugin with annual payment. Need to find a solution for build new video player with feature:</p><ul> <li>pre/post roll advertising</li> <li>VAST ad</li> <li>streaming HLS (online stream)</li> <li>read file with .m3u8</li> <li>quality changing menu</li> <li>all modern browsers (ie10+)</li> <li>all mobile & tablet browsers (android 4.4+, iOs7+)</li> <li>fullScreen</li> <li>include player in different place on site, in topline in small area & popup, also 2 view in content area in infinite scrolling</li> <li>to apply this solution for all projects of company rbc.ru, tv.rbc.ru, rbc.ru/newspaper, www.rbc.ru/magazine, quote.rbc.ru, autonews.ru, sport.rbc.ru, realty.rbc.ru ... </li></ul>',
  ...
  },
  {
    ...
    descCompany:
      'Russian Bank providing banking services to both legal entities and individuals',
    numberImg: 16,
  ...
  },
  {
    ...
    descCompany:
      'International online travel Agency. Service offices are open in Ukraine, Germany, USA and Switzerland',
    numberImg: 4,
    descDeal: `<div>
  ...
  },
  {
    ...
    numberImg: 7,
    descDeal:
      'First job in frontend develpmpent, my work included mainly layouts, started work with js. Completed courses js, php, mysql. Afterwards expanded my responsibilities with this knowledge. some works lives up to date: <br><a href="http://www.belbereg.ru/" target="_blank">belbereg.ru</a><br><a href="http://www.imperialtea.ru/" target="_blank">imperialtea.ru</a><br><a href="http://www.trans-i.ru" target="_blank">trans-i.ru</a><br>',
